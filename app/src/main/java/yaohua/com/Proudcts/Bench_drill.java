...
public class Bench_drill extends AppCompatActivity {

    private static final String TAG = "Bench_drill";
    ...
    //Widgets//
    private Context mcontext = Bench_drill.this;
    private Context ycontext = Bench_drill.this;
    private Context bcontext = Bench_drill.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bench_drill);
        ...
        //bottom navigation//
        bottomNavigationView = (BottomNavigationView)findViewById(R.id.bottomNAV8);
    ...
    private void init() {
        ...
        Query query = reference.child("Bench drill");
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        case R.id.Homepage:
                            startActivity(new Intent(Bench_drill.this, Homepage.class));
                            break;

                        case R.id.Hot_sells:
                            startActivity(new Intent(Bench_drill.this, Hot_sells.class));
                            break;

                        case R.id.PersonalPage:
                            startActivity(new Intent(Bench_drill.this, Mine.class));
                            break;
                    }
