...
public class Bender extends AppCompatActivity {

    private static final String TAG = "Bender";
    ...
    //Widgets//
    private Context mcontext1 = Bender.this;
    private Context ycontext1 = Bender.this;
    private Context bcontext1 = Bender.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bender);

        Log.d(TAG, "onCreated started");

        recyclerView1 = (RecyclerView) findViewById(R.id.recyclerView7);
        ...
        //bottom navigation//
        bottomNavigationView = (BottomNavigationView)findViewById(R.id.bottomNAV10);
    ...
    private void init() {
        ...
        Query query = reference1.child("Bender");
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        case R.id.Homepage:
                            startActivity(new Intent(Bender.this, Homepage.class));
                            break;

                        case R.id.Hot_sells:
                            startActivity(new Intent(Bender.this, Hot_sells.class));
                            break;

                        case R.id.PersonalPage:
                            startActivity(new Intent(Bender.this, Mine.class));
                            break;
                    }
