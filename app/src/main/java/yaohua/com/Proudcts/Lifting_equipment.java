...
public class Lifting_equipment extends AppCompatActivity {

    private static final String TAG = "Lifting_equipment";
    ...
    //Widgets//
    private Context mcontext1 = Lifting_equipment.this;
    private Context ycontext1 = Lifting_equipment.this;
    private Context bcontext1 = Lifting_equipment.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lifting_equipment);
        ...
        //bottom navigation//
        bottomNavigationView = (BottomNavigationView)findViewById(R.id.bottomNAV7);
    ...
    private void init() {
        ...
        Query query = reference1.child("Lifting equipment");
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        case R.id.Homepage:
                            startActivity(new Intent(Lifting_equipment.this, Homepage.class));
                            break;

                        case R.id.Hot_sells:
                            startActivity(new Intent(Lifting_equipment.this, Hot_sells.class));
                            break;

                        case R.id.PersonalPage:
                            startActivity(new Intent(Lifting_equipment.this, Mine.class));
                            break;
                    }
