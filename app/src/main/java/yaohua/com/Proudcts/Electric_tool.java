...
public class Electric_tool extends AppCompatActivity {

    private static final String TAG = "Electric_tool";
    ...
    //Widgets//
    private Context mcontext = Electric_tool.this;
    private Context ycontext = Electric_tool.this;
    private Context bcontext = Electric_tool.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electric_tool);
        ...
        //bottom navigation//
        bottomNavigationView = (BottomNavigationView)findViewById(R.id.bottomNAV5);
    ...
    private void init() {
        ...
        Query query = reference.child("Electric equipment");
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        case R.id.Homepage:
                            startActivity(new Intent(Electric_tool.this, Homepage.class));
                            break;

                        case R.id.Hot_sells:
                            startActivity(new Intent(Electric_tool.this, Hot_sells.class));
                            break;

                        case R.id.PersonalPage:
                            startActivity(new Intent(Electric_tool.this, Mine.class));
                            break;
                    }
