...
public class Ladder extends AppCompatActivity {
    ...
    //Widgets//
    private Context mcontext = Ladder.this;
    private Context ycontext = Ladder.this;
    private Context bcontext = Ladder.this;
    ...
    private void init() {
        ...
        Query query = reference.child("Ladder");
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        case R.id.Homepage:
                            startActivity(new Intent(Ladder.this, Homepage.class));
                            break;

                        case R.id.Hot_sells:
                            startActivity(new Intent(Ladder.this, Hot_sells.class));
                            break;

                        case R.id.PersonalPage:
                            startActivity(new Intent(Ladder.this, Mine.class));
                            break;
                    }
