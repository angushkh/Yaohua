...
public class Welding_equipment extends AppCompatActivity {

    private static final String TAG = "Welding_equipment";
    ...
    //Widgets//
    private Context mcontext = Welding_equipment.this;
    private Context ycontext = Welding_equipment.this;
    private Context bcontext = Welding_equipment.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_welding_equipment);
    ...
    private void init() {
        ...
        Query query = reference.child("Welding equipment");
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        case R.id.Homepage:
                            startActivity(new Intent(Welding_equipment.this, Homepage.class));
                            break;

                        case R.id.Hot_sells:
                            startActivity(new Intent(Welding_equipment.this, Hot_sells.class));
                            break;

                        case R.id.PersonalPage:
                            startActivity(new Intent(Welding_equipment.this, Mine.class));
                            break;
                    }
